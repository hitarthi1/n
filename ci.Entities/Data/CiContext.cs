...
public partial class CiContext : DbContext
{
    ...
    public virtual DbSet<PasswordReset3> PasswordReset3s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=PCA190\\SQL2017;Database=CI;User Id=sa;Password=Tatva@123; TrustServerCertificate=true; Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Admin__4A311D2FBD7236E4");

            entity.ToTable("Admin");

            entity.HasIndex(e => e.Email, "UQ__Admin__A9D105342E2803E1").IsUnique();
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__Banner__8174A02CDC58567E");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__City__DE9CEC38A0D202A9");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52914AC738");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__Country__8037C7D6266DF779");
        ...
        {
            entity.HasKey(e => e.FavouritMissionId).HasName("PK__favourit__16E34B4CA56C7818");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7FC8E0154");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__Mission__93DC24EA93DC001B");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838AFDFEFFF9");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___537947662F53C79B");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A1126E842D4E3033");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8600B7D7B");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51725191FFC6");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___827120083B118987");
        ...
        modelBuilder.Entity<PasswordReset>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__password__A9D105349DE3F4B9").IsUnique();
        ...
        modelBuilder.Entity<PasswordReset2>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("password_reset2");

            entity.HasIndex(e => e.Token, "UQ__password__CA90DA7A87693255").IsUnique();
        ...
        modelBuilder.Entity<PasswordReset3>(entity =>
        {
            entity.HasKey(e => e.Token).HasName("PK__password__CA90DA7B12EDE4B6");

            entity.ToTable("password_reset3");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__Skills__B4AAE68864B0A970");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C5610290F75");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053CC45D6151");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__stoty_in__044978674E18224D");
        ...
        {
            entity.HasKey(e => e.ThemeId).HasName("PK__Theme__59291A6A9EBAE868");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068642B833A");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__206A9DF8CB160F49");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534D8339EA8").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B95C39184");
